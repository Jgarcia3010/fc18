...
class ProductElectronic(models.Model):
    ...
    codigo_sunat = fields.Char(string="Código SUNAT")
    unidad_medida = fields.Many2one('uom.uom', string="Unidad de Medida")
    code_type_id = fields.Many2one('some.model', string="Tipo de Código")
    commercial_measurement = fields.Float(string="Medida Comercial")
    economic_activity_id = fields.Many2one('economic.activity', string="Actividad Económica")
    non_tax_deductible = fields.Boolean(string="No Deducible", default=False)
