...
def action_invoice_sent(self):
        ...
        # Determinar la plantilla de email según el tipo
        if self.move_type in ['in_invoice', 'in_refund']:
        ...
        # Preparar adjuntos XML si es factura electrónica
        ...
        # Usar el método estándar de Odoo 18
        return super(AccountInvoiceElectronic, self).action_invoice_sent()