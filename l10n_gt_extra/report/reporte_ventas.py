    ...
    def lineas(self, datos):
        ...
        for f in facturas:
            ...
            for l in f.invoice_line_ids:
                ...
                tipo_linea = l.product_id.x_studio_bien_o_servicio
                if tipo_linea:
                ...
                if len(l.tax_ids) > 0:
                    ...
                    linea['importacion'] += base_price  
                    linea['importacion_exento'] += base_price  
                    linea['total_extento'] += base_price
                    totales['importacion']['exento'] += base_price  
                ...
                linea['base'] = f.amount_untaxed_signed
            lineas.append(linea)
