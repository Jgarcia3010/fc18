...
class AsistenteReporteCompras(models.TransientModel):
    ...
    impuesto_id = fields.Many2one("account.tax", string="Impuesto", required=True, domain="[('type_tax_use', '=', 'purchase')]", default=_get_default_tax)
    ...
    def print_report_excel(self):
        for w in self:
            ...
            dict['impuesto_id'] = [w.impuesto_id.id, w.impuesto_id.name] # this is not necessary anymore, since the report will be on all taxes
            ...
            hoja.write_merge(y, y, 11, 13, 'Base Exenta')
            ...
            hoja.write(y, 11, 'Bienes')
            hoja.write(y, 12, 'Servicios')
            hoja.write(y, 13, 'Combustibles')
            hoja.write(y, 14, 'IDP')
            hoja.write(y, 15, 'Total IVA Crédito Fiscal')
            hoja.write(y, 16, 'Total')
            hoja.write(y, 17, 'Total - IDP')
            hoja.write(y, 18, 'Origen')
            ...
            for linea in lineas:
                ...
                hoja.write(y, 6, linea['proveedor'])
                ...
                hoja.write(y, 11, linea['compra_exento'])
                hoja.write(y, 12, linea['servicio_exento'])
                hoja.write(y, 13, linea['combustible_exento'])
                hoja.write(y, 14, linea['idp'])
                hoja.write(y, 15, linea['iva'])
                hoja.write(y, 16, linea['total'])
                hoja.write(y, 17, linea['total']-linea['idp'])
                hoja.write(y, 18, linea['origen'])
            ...
            #hoja.write(y, 11, totales['compra']['exento']+totales['servicio']['exento'])
            hoja.write(y, 11, totales['compra']['exento'])
            hoja.write(y, 12, totales['servicio']['exento'])
            hoja.write(y, 13, totales['combustible']['exento'])
            hoja.write(y, 14, totales['compra']['idp'])
            hoja.write(y, 15, totales['compra']['iva'] + totales['servicio']['iva']+totales['combustible']['iva']+totales['importacion']['iva'])
            hoja.write(y, 16, totales['total'])
            ...
            hoja.write(y, 6, 0)
            hoja.write(y, 7, totales['compra']['exento']+totales['compra']['neto']+totales['compra']['iva'])
            y += 1
            ...
            hoja.write(y, 6, 0)
            hoja.write(y, 7, totales['servicio']['exento']+totales['servicio']['neto']+totales['servicio']['iva'])
            y += 1
            ...
            hoja.write(y, 6, totales['compra']['idp'])
            hoja.write(y, 7, totales['combustible']['exento']+totales['combustible']['neto']+totales['combustible']['iva']+totales['compra']['idp'])
            y += 1
            ...
            hoja.write(y, 5, 0)
            hoja.write(y, 6, 0)
            hoja.write(y, 7, totales['importacion']['exento']+totales['importacion']['neto']+totales['importacion']['iva'])
            y += 1
            ...
            hoja.write(y, 5, totales['compra']['iva']+totales['servicio']['iva'] +
                       totales['combustible']['iva']+totales['importacion']['iva'])
            hoja.write(y, 6, totales['compra']['idp'])
            hoja.write(y, 7, totales['compra']['exento']+totales['compra']['neto']+totales['compra']['iva']+totales['servicio']['exento']+totales['servicio']['neto']+totales['servicio']['iva']+totales['combustible']['exento']+totales['combustible']['neto']+totales['combustible']['iva']+totales['importacion']['exento']+totales['importacion']['neto']+totales['importacion']['iva']+totales['compra']['idp'])
